...
emailField.value = savedEmail; // Set the email field value
    ...
    form.addEventListener('submit', (event) => {
        ...
        evaluations.forEach((evaluation, index) => {
            ...
            evaluation.remarks.forEach((remark, remarkIndex) => {
                ...
                yPosition += 10;
                if (remark.image) {
                    const imgWidth = 115; // Decreased image size for PDF
                    const imgHeight = 75; // Maintain aspect ratio
